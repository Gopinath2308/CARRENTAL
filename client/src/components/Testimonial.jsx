...
const Testimonial = () => {
    const cardsData = [
        ...
        },
        {
            ...
            date: 'May 10, 2025',
            testimonial: "I recently used CarRental for a weekend trip, and I must say, it was one of the smoothest car rental experiences I've had. From start to finish, everything was seamless and user-friendly."
        },
        {
            image: assets.testimonial_image_1,
            name: 'Jordan Lee',
            ...
            date: 'June 5, 2025',
            testimonial:"I booked a car through CarRental for a short solo trip, and I was genuinely impressed by the value they offer."
        },
        {
            image: assets.testimonial_image_2,
            name: 'Avery Johnson',
            location: 'New York, USA',
            date: 'May 10, 2025',
            testimonial:"My experience with CarRental was nothing short of amazing. I rented a luxury sedan for a special anniversary trip and was blown away by both the vehicle quality and the service."
        },
    ];

    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4  transition-all duration-200 w-72 shrink-0 border-1 border-cyan-900 shadow-[2px_2px_15px_rgba(0,255,255,0.2)] hover:shadow-[2px_3px_15px_rgba(0,255,255,0.3)]">
            ...
            <p className="text-sm py-4 text-gray-400">{card.testimonial}</p>
