...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-gray-700 text-sm'>

        <div className='group relative'>
            <label htmlFor="image">
                <img src={image ? URL.createObjectURL(image) : user?.image || "https://img.directhotels.com/in/uluberia/rupasi-rupnarayan-kuthi/1.jpg"} alt='' className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto' />
